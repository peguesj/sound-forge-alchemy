defmodule SoundForge.Accounts.User do
  ...
  schema "users" do
    ...
    field :role, Ecto.Enum, values: [:user, :pro, :enterprise, :admin, :super_admin, :platform_admin], default: :user
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, SoundForge.Repo)
  ...
  """
  def valid_password?(%SoundForge.Accounts.User{hashed_password: hashed_password}, password)
