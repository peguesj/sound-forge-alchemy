        ...
        <div class="overflow-y-auto flex-1 divide-y divide-gray-800">
          <div :for={{entry, idx} <- Enum.with_index(@entries)} class="px-6 py-4 space-y-3">
            ...
            <div class="flex items-center gap-2.5">
              ...
              <span
                :if={idx == 0}
                class="text-[10px] font-semibold uppercase tracking-wide bg-green-900/50 text-green-400 px-1.5 py-0.5 rounded"
              >
                Latest
              </span>
            </div>
            ...
            <div :for={section <- entry.sections} class="space-y-1.5">
              ...
              <ul class="space-y-1 pl-1">
                <li
                  ...
                  class="flex items-start gap-2 text-xs text-gray-300 leading-relaxed"
                >
