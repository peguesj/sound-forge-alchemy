defmodule SoundForgeWeb.Telemetry do
  ...
  def metrics do
    [
      ...
      # Database Metrics
      summary("sound_forge.repo.query.total_time",
        unit: {:native, :millisecond},
        description: "The sum of the other measurements"
      ),
      summary("sound_forge.repo.query.decode_time",
        unit: {:native, :millisecond},
        description: "The time spent decoding the data received from the database"
      ),
      summary("sound_forge.repo.query.query_time",
        unit: {:native, :millisecond},
        description: "The time spent executing the query"
      ),
      summary("sound_forge.repo.query.queue_time",
        unit: {:native, :millisecond},
        description: "The time spent waiting for a database connection"
      ),
      summary("sound_forge.repo.query.idle_time",
        unit: {:native, :millisecond},
        description:
