defmodule SoundForgeWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :sound_forge
  ...
  plug Plug.Static,
    ...
    only: SoundForgeWeb.static_paths(),
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :sound_forge
  end
